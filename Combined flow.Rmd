...
cleaned_data <- data %>%
  ...
  dplyr::select(Chemical, Sample, Group, Treatment, Sex, Smokers, CD3, CD3_fi, CD4, CD4_fi, CD8, CD8_fi, live, CD3_ud, CD4_ud, CD8_ud, Ms, Ms_fi, Ms_ud)
...
write.csv(filtered_datasets, "../Flow cyto (PBMCs)/Combined_flow_pha_fi.csv")
...
filtered_datasets <- datasets[names(datasets) %in% selected_objects]
write.csv(filtered_datasets, "../Flow cyto (PBMCs)/Combined_flow_pha.csv")
combined_data <- data.frame()
significance_results <- list()
