...
output_dir <- "C:/Users/aloan/OneDrive - HC-SC PHAC-ASPC/Desktop/invitro pfas//plots_output/"
...
data_PFOS <- read.csv("C:/Users/aloan/OneDrive - HC-SC PHAC-ASPC/Desktop/invitro pfas/Flow cyto (PBMCs)/20-Dec-2024.wsp FlowJo table.csv") %>%
...
cleaned_data <- data %>%
  ...
  dplyr::select(Chemical, Sample, Group, Treatment, Sex, Smokers, CD3, CD3_fi, CD4, CD4_fi, CD8, CD8_fi, live, CD3_ud, CD4_ud, CD8_ud, Ms, Ms_fi, Ms_ud, dead_fi)
...
numeric_columns <- c("CD3", "CD4", "CD8",  "live", "CD3_ud", "CD4_ud", "CD8_ud", "CD8_fi", "CD4_fi", "CD3_fi", "Ms", "Ms_fi", "Ms_ud", "dead_fi")
cleaned_data <- cleaned_data %>%
...
columns <- c("live", "CD3", "CD4", "CD8", "CD3_fi", "CD4_fi", "CD8_fi","CD3_divided", "CD4_divided", "CD8_divided", "CD4_fi_reciprocal", "CD3_fi_reciprocal", "CD8_fi_reciprocal", "Ms", "Ms_fi_reciprocal", "Ms_divided", "dead_fi_reciprocal")
