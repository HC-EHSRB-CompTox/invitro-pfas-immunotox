...
# --- Write CSV ---
write.csv(deg_common, "../invitro-pfas-immunotox/DEG_common_all_chemicals.csv", row.names = FALSE)
...
```{r}
# Read counts table
counts <- read_tsv("../invitro-pfas-immunotox/count_table.tsv") 
gene_ids <- counts[[1]]
counts_mat <- as.matrix(counts[,-1])
rownames(counts_mat) <- gene_ids


# --- 2. Get list of DE genes ---
# Assume deg_combined has column 'Gene_Symbol' or 'Ensembl_Gene_ID' and Significant == "Up"/"Down"
